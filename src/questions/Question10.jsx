...
export function CriteriaOfStudentCertification({ studentData }) {
  const sumOfMarks = studentData.reduce((sum, { marks }) => sum + marks, 0);
  const mean = sumOfMarks / studentData.length;
  console.log(mean);
  return (
    <div>
